            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <h3 className="text-lg font-medium text-foreground mt-4">1.3 Information from Third Parties</h3>
                  <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">Depending on your location, you may have certain rights regarding your personal information:</p>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-foreground mb-4">9. California Privacy Rights (CCPA)</h2>
                <p className="text-muted-foreground mb-4">
          ...
          content: (
            <div className="space-y-8">
              ...
              <section>
                ...
                <h3 className="text-lg font-medium text-foreground mt-4 mb-2">5.2 Our Intellectual Property</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-lg font-medium text-foreground mt-4 mb-2">5.3 Analysis Results</h3>
                <p className="text-muted-foreground">
              ...
              <section>
                ...
                <h3 className="text-lg font-medium text-foreground mt-4 mb-2">6.1 No Professional Appraisal</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-lg font-medium text-foreground mt-4 mb-2">6.2 Accuracy Disclaimer</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-lg font-medium text-foreground mt-4 mb-2">6.3 Service Availability</h3>
                <p className="text-muted-foreground">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-foreground mb-4">9. Third-Party Services and Links</h2>
                <p className="text-muted-foreground">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-foreground mb-4">10. Payments and Subscriptions</h2>
                <h3 className="text-lg font-medium text-foreground mt-4 mb-2">10.1 Pricing</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-lg font-medium text-foreground mt-4 mb-2">10.2 Subscriptions</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-lg font-medium text-foreground mt-4 mb-2">10.3 Price Changes</h3>
                <p className="text-muted-foreground">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-foreground mb-4">11. Dispute Resolution and Arbitration</h2>
                <h3 className="text-lg font-medium text-foreground mt-4 mb-2">11.1 Informal Resolution</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-lg font-medium text-foreground mt-4 mb-2">11.2 Binding Arbitration</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-lg font-medium text-foreground mt-4 mb-2">11.3 Class Action Waiver</h3>
                <p className="text-muted-foreground">

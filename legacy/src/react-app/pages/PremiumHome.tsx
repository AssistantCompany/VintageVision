...
import PremiumHeader from '@/react-app/components/enhanced/PremiumHeader'
import PremiumFooter from '@/react-app/components/enhanced/PremiumFooter'
import MobileOptimizedImageUploader from '@/react-app/components/mobile/MobileOptimizedImageUploader'
import PremiumAnalysisResult from '@/react-app/components/enhanced/PremiumAnalysisResult'
import ImageUploadTester from '@/react-app/components/enhanced/ImageUploadTester'
...
import AdvancedLoadingSpinner from '@/react-app/components/ui/AdvancedLoadingSpinner'
  ...
  const handleImageSelected = async (dataUrl: string) => {
    ...
    if (analysis) {
      ...
      trackEvent('analysis_completed', { 
        ...
        hasValue: !!(analysis.estimated_value_min || analysis.estimated_value_max)
      })
      
      // Send premium notification
      notifications.premium(
        `Analysis complete: ${analysis.name}`,
        analysis.estimated_value_min ? `Estimated value: $${analysis.estimated_value_min.toLocaleString()}+` : undefined
      )
    } else if (error) {

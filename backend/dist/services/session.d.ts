 ...
 */
export declare function initializeSessionStore(): Promise<import("@redis/client").RedisClientType<{
    graph: {
 ...
 */
export declare function refreshSession(token: string): Promise<void>;
